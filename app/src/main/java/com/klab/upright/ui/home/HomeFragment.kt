    ...
    private fun init() {
        ...
        for (i in 0..pressureLine) {
            val v = LayoutInflater.from(context)
                .inflate(R.layout.item_pressure, linearLayout_left1, false)
            if (i == pressureLine) {
        ...
        for (i in 0..pressureLine) {
            val v = LayoutInflater.from(context)
                .inflate(R.layout.item_pressure, linearLayout_left2, false)
            if (i == pressureLine) {
                v.item.layoutParams = params2
            } else {
                v.item.layoutParams = params
        ...
        for (i in 0..pressureLine) {
            val v = LayoutInflater.from(context)
                .inflate(R.layout.item_pressure, linearLayout_right1, false)
            if (i == pressureLine) {
                v.item.layoutParams = params2
            } else {
                v.item.layoutParams = params
        ...
        for (i in 0..pressureLine) {
            val v = LayoutInflater.from(context)
                .inflate(R.layout.item_pressure, linearLayout_right2, false)
            if (i == pressureLine) {
                v.item.layoutParams = params2
            } else {
                v.item.layoutParams = params
